...
- (void)getDataCompletionHandle:(void (^)(NSError *))completed{
    self.dataTask = [LWTMoreNetManager getCategoryForCategoryId:_categoryId tagName:_name pageSize:_pageSize completionHandle:^(ContentCategoryModel* responseObject, NSError *error) {
...
- (NSURL *)coverURLForRow:(NSInteger)row{
    NSString *path = self.model.list[row].coverMiddle;
