...
@implementation LWTMoreCategoryCell
...
- (UILabel *)playsLb {
    if (!_playsLb) {
        ...
        self.IV = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@""]];
...
- (UILabel *)tracksLb {
    if (!_tracksLb) {
        ...
        self.UIV = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@""]];
